...
class Cutout:
    ...
    def __init__(
        ...
        if os.path.isdir(self.cutout_dir):
            ...
            if (
                ...
                and all(
                    ...
                    for y in range(params_dict["years"].start, params_dict["years"].stop + 1)
                    for m in range(params_dict["months"].start, params_dict["months"].stop + 1)
                )
            ):
        ...
        if not self.prepared:
            ...
            self.dataset_module = sys.modules["geodata.datasets." + params_dict["module"]]
    ...
    def add_grid_area(self, axis: tuple[str] = ("lat", "lon"), adjust_coord: bool = True):
    ...
    def mask(
        self, dataset: xr.Dataset, true_area: bool = True, merged_mask: bool = True, shape_mask: bool = True
    ):
    ...
    def _convert_cutout(self, convert_func: callable, show_progress: bool = False, **convert_kwds):
    ...
    def temperature(self, **params):
        ...
        """
        return self._convert_cutout(convert_func=lambda ds: ds["temperature"] - 273.15, **params)
    ...
    def wind(self, turbine: Union[str, dict], smooth: Union[bool, dict] = False, **params):
        """
