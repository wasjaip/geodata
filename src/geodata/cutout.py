...
class Cutout:
    ...
    def temperature(self, **convert_params):
        ...
        """
        return self._convert_cutout(convert_func=lambda ds: ds["temperature"] - 273.15, **convert_params)
    ...
    def soil_temperature(self, **convert_params):
        ...
        """
        return self.convert_cutout(
            convert_func=lambda ds: (ds["soil temperature"] - 273.15).fillna(0.0), **convert_params
        )
